...
class MVCCSimulator(TransactionSimulator):
    ...
    def process(self, op_queue, is_root=False):
        if is_root:
            self.maxval = self.__find_max_ts(op_queue)
